...
public class C01_ExplicitlyWait extends TestBase {
    ...
    public void implicitWaitTesti() throws InterruptedException {
        ...
        //implicitlyWait  OLMASAYDI BEKLEME OLMADAN TESTİ YAPMAYA KALKACAKTI OZAMNDA ELEMNTİ BULAMIYACAGINDAN HATA ALIRDIK
       ...
       driver.findElement(By.xpath("//button[.='Remove']")).click();
        ...
        WebElement backText=driver.findElement(By.xpath("//p[@id='message']"));
        Assert.assertTrue(backText.isDisplayed());
    ...
    @Test
    public void explicitWaitTesti() throws InterruptedException {
