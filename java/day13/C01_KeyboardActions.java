...
public class C01_KeyboardActions extends TestBase {
    ...
    public void test01() throws InterruptedException {
        ...
        //iframe içinden oldugundan önce ıframe geçişyapmalıyız
       ...
       driver.findElement(By.xpath("//button[@class='ytp-large-play-button ytp-button']")).click();
         ...
         //driver.findElement(By.xpath("//iframe[@class='lazy-loaded']")).click();
      ...
      //  Assert.assertTrue(pauseButton.isEnabled());
        ...
        //xpath bunu deneyin //button[@title='Duraklat (k)']
