...
public class C02_Xpath {
    public static void main(String[] args) {
       ...
       //2- Add Element butonuna basin
        ...
        WebElement addYazisiElementi=driver.findElement(By.tagName("h3"));
      //  WebElement addYazisiElementi1=driver.findElement(By.xpath("//h3"));

          if (addYazisiElementi.isDisplayed()){
              System.out.println("add yazisi görünür testi PASS");
          }else {
              System.out.println("add yazisi görünür testi FAİLED");
          }
